  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Objetivo diario de agua establecido por la IA</CardDescription>
      </CardHeader>
      <CardContent>
        <div className="space-y-3 text-sm">
          <p className="text-muted-foreground">
            El objetivo de hidratación es calculado automáticamente por nuestro modelo de IA en función de tus datos y objetivos. Esta meta es fija en esta sección para mantener la coherencia del plan.
          </p>
