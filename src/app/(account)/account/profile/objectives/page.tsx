  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Configura tu objetivo general y peso objetivo. Las metas de macros y agua se calculan y muestran como referencia.</p>
      </div>
      <Card>
        <CardHeader>
          <CardTitle>Metas del plan</CardTitle>
          <CardDescription>Define tu objetivo y ajusta tu peso objetivo.</CardDescription>
        </CardHeader>
        <CardContent>
